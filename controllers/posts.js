...
exports.updatePost = asyncHandler(async (req, res, next) => {
    ...
    const updateData = await Post.findByIdAndUpdate(post_id, update, {
        new: true,
        runValidators: true
    });
    if (!updateData) {
...
exports.deletePost = asyncHandler(async (req, res, next) => {
    const user_id = await Post.findById(req.params.id);

    const deleteData = await Post.findByIdAndDelete(user_id);
